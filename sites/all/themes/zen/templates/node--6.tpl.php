...
<div id="node-<?php print $node->nid; ?> <?php print $classes; ?> clearfix"<?php print $attributes; ?>>
  ...
  <style media="screen" type="text/css">
	...
	.pharmacist_04{width:87%;margin-top:-10px;padding:10px;background:#CECECE;}
	...
	.research_team_04{width:87%;margin-top:-10px;padding:10px;background:#CECECE;}
  		...
  		<div class="contact_background">
  			...
  			<div class="pharmacist_contact">
  				...
  				<p class="pharmacist_01">	
  					Quick Rx Pharmacy (Wash. Heights)</br>
  					27 Audubon Ave.</br>
				...
				<p class="pharmacist_03">	
  					Quick Rx Pharmacy (East Harlem)</br>
					1875 Lexington Ave.</br>
					SP: Blessing Achudbe</br>
					212-410-0911</br>
					<a href="ba2428@columbia.edu">ba2428@columbia.edu</a>
				</p>
				
				<p class="pharmacist_04">
					Gotham Pharmacy</br>
					2258 Third Ave.</br>
					SP: Lynn Young</br>
					212-289-7800</br>
					<a href="gothampharmacy@gmail.com">gothampharmacy@gmail.com</a>
  				</p>
  			...
  			<div class="research_contact">
				...
				<p class="research_team_03">	
  					Ghonchech Giasian</br>
					Research Coordinator</br>
					212-304-5541</br>
					<a href="gg2452@columbia.edu">gg2452@columbia.edu</a>
				</p>
				
				<p class="research_team_04">	
  					Marlene Ramos</br>
					Research Coordinator</br>
					212-304-3417</br>
					<a href="mr3088@columbia.edu">mr3088@columbia.edu</a>
				</p>
