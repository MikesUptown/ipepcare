...
//print_r($content[body][0]['#markup']);
//print_r($content[body]['#object']->title);
//print_r($content[body]['#object']->field_video_code['und'][0]['value']);
//print_r($content[body]['#object']->body['und'][0]['value']);

?>
<div>
    <div class="help-center-title">
        <a href="#body-<?php echo $content[body]['#object']->nid;?>" rel="prettyPhoto">
    ...
    <div class="help-center-body">
        ...
        <div id="body-<?php echo $content[body]['#object']->nid;?>" style="display:none;">
            <div class="teaser-hc-top">
                 <?php echo $content[body]['#object']->title; ?>
            </div>
            <div >  
                <div class="teaser-hc-left">
                    <div class="teaser-hc-body"> 
                        <?php echo $content[body]['#object']->body['und'][0]['value'];?>
                    </div>
                </div>  
                <div  class="teaser-hc-right">
                    <embed
                    width="420" height="345"
                    src="<?php echo $content[body]['#object']->field_video_code['und'][0]['value']; ?>"
